...
jb&&(ib=jb?jb[1]:"");if(bb){var kb=fb();if(null!=kb&&kb>parseFloat(ib)){hb=String(kb);break a}}hb=ib}var lb=hb,mb;if(x.document&&bb){var nb=fb();mb=nb?nb:parseInt(lb,10)||void 0}else mb=void 0;var ob=mb;var pb={},qb=null;var H=window;function rb(a){var b=y("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflcS5aan/window.location.href");null==a&&(a='Unknown Error of type "null/undefined"');if("string"===typeof a)return{message:a,name:"Unknown error",lineNumber:"Not available",fileName:b,stack:"Not available"};var c=!1;try{var d=a.lineNumber||a.line||"Not available"}catch(f){d="Not available",c=!0}try{var e=a.fileName||a.filename||a.sourceURL||x.$googDebugFname||b}catch(f){e="Not available",c=!0}return!c&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:(b=a.message,null==b&&(a.constructor&&
...
function Jc(a){var b=y("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflcS5aan/yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,void 0):(b=Q("ERRORS",[]),b.push([a,"ERROR",void 0,void 0,void 0]),Fc("ERRORS",b))}
function Kc(a){var b=y("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflcS5aan/yt.logging.errors.log");b?b(a,"WARNING",void 0,void 0,void 0):(b=Q("ERRORS",[]),b.push([a,"WARNING",void 0,void 0,void 0]),Fc("ERRORS",b))}
...
function Vd(a){var b=window.location.search,c=J(I(a)[3]||null),d=J(I(a)[5]||null);d=(c=c&&(c.endsWith("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflcS5aan/youtube.com")||c.endsWith("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflcS5aan/youtube-nocookie.com")))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=Wc(b),f={};E(Rd,function(l){e[l]&&(f[l]=e[l])});
return Yc(a,f||{},!1)}
...
function ge(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflcS5aan/www.youtube-nocookie.com"))return d;(b=c.ra||Q("AUTHORIZATION"))||(a?b="Bearer "+y("gapi.auth.getToken")().qa:b=Pb([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),U("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
...
ie.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,B()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(oc(b))}catch(f){return}else e=escape(b);b=this.g;ub.set(""+a,e,{L:c,path:"/",domain:void 0===b?"https://s.ytimg.com/yts/jsbin/www-widgetapi-vflcS5aan/youtube.com":b,secure:!1})};
...
timeout:d.timeout,withCredentials:!0},f="",l=a.f.aa;l&&(f=l);l=a.f.ba||!1;var g=ge(l,f,d);Object.assign(e.headers,g);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var h=Xc(""+f+("/youtubei/"+a.f.innertubeApiVersion+"/"+b),{alt:"json",key:a.f.innertubeApiKey}),k;if(d.retry&&U("retry_web_logging_batches")&&"https://s.ytimg.com/yts/jsbin/www-widgetapi-vflcS5aan/www.youtube-nocookie.com"!=f&&(k=je(b,c,g,l))){var m=e.onSuccess,n=e.M;e.onSuccess=function(q,p){ke(k);m(q,p)};
...
;C("YT.PlayerState.UNSTARTED",-1);C("YT.PlayerState.ENDED",0);C("YT.PlayerState.PLAYING",1);C("YT.PlayerState.PAUSED",2);C("YT.PlayerState.BUFFERING",3);C("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflcS5aan/YT.PlayerState.CUED",5);C("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflcS5aan/YT.get",function(a){return ad[a]});
C("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflcS5aan/YT.scan",dd);C("YT.subscribe",function(a,b,c){qc.subscribe(a,b,c);cd[a]=!0;for(var d in ad)te(ad[d],a)});
